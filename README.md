...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{W} \sum_{i=0}^{W-1} x_i" data-equation="eq:arithmetic_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@c33d0b9b2c4073fa60e3ead858f516ba914f8b03/lib/node_modules/@stdlib/stats/incr/nanmmeanstdev/docs/img/equation_arithmetic_mean.svg" alt="Equation for the arithmetic mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="s = \sqrt{\frac{1}{W-1} \sum_{i=0}^{W-1} ( x_i - \bar{x} )^2}" data-equation="eq:corrected_sample_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@c33d0b9b2c4073fa60e3ead858f516ba914f8b03/lib/node_modules/@stdlib/stats/incr/nanmmeanstdev/docs/img/equation_corrected_sample_standard_deviation.svg" alt="Equation for the corrected sample standard deviation.">
    <br>
</div> -->
...
```javascript
incrnanmmeanstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmeanstdev@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmmeanstdev = require( 'path/to/vendor/umd/stats-incr-nanmmeanstdev/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmeanstdev@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nanmmeanstdev.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nanmmeanstdev

[test-image]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nanmmeanstdev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nanmmeanstdev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nanmmeanstdev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nanmmeanstdev/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nanmmeanstdev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nanmmeanstdev/main/LICENSE
