...
* // returns null
*/
declare function incrnanmmeanstdev( out: ArrayLike<number>, window: number ): accumulator;
...
* // returns [ 0.0, ~4.36 ]
*/
declare function incrnanmmeanstdev( window: number ): accumulator;


// EXPORTS //

export = incrnanmmeanstdev;
